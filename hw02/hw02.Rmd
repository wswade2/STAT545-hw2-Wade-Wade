...
class(gapminder) 
# This command is probably more simple to use, but I like when R yells TRUE or FALSE at me. According to this function, the dataset consists these classes:"tbl_df," "tbl" and "data.frame."
